!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      function i(e) {
        const t = a.chains.find((t) => t.chainId === e);
        if (void 0 === t)
          throw new Error("No chain found matching chainId: " + e);
        return t;
      }
      function o(e, t) {
        let n;
        const a = r().filter((n) => n[e] === t);
        if ((a && a.length && (n = a[0]), void 0 === n))
          throw new Error(`No chain found matching ${e}: ${t}`);
        return n;
      }
      function s(e) {
        return o("networkId", e);
      }
      (t.getAllChains = r),
        (t.getChain = i),
        (t.getChainByChainId = function (e) {
          return i(e);
        }),
        (t.getChainByKeyValue = o),
        (t.getChainByNetworkId = s),
        (t.convertNetworkIdToChainId = function (e) {
          return s(e).chainId;
        }),
        (t.convertChainIdToNetworkId = function (e) {
          return i(e).networkId;
        });
    },
  ]);
});
